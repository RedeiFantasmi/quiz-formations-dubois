...
return [
    ...
    'app_copie_get_data' => [['id'], ['_controller' => 'App\\Controller\\CopieController::index'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/copie']], [], [], []],
    'app_copie_correctcopie' => [['id'], ['_controller' => 'App\\Controller\\CopieController::correctCopie'], [], [['text', '/correct'], ['variable', '/', '[^/]++', 'id', true], ['text', '/copie']], [], [], []],
    'app_copie_copielock' => [['id'], ['_controller' => 'App\\Controller\\CopieController::copieLock'], [], [['text', '/lock'], ['variable', '/', '[^/]++', 'id', true], ['text', '/copie']], [], [], []],
    ...
    'app_evaluation_lock' => [['id'], ['_controller' => 'App\\Controller\\EvaluationController::lockEvaluation'], [], [['text', '/lock'], ['variable', '/', '[^/]++', 'id', true], ['text', '/evaluation']], [], [], []],
    'app_evaluation_create_copie' => [['id'], ['_controller' => 'App\\Controller\\EvaluationController::createCopie'], [], [['text', '/copie/create'], ['variable', '/', '[^/]++', 'id', true], ['text', '/evaluation']], [], [], []],
    'app_formation' => [[], ['_controller' => 'App\\Controller\\FormationController::index'], [], [['text', '/formation']], [], [], []],
    'app_formation_getformationeleves' => [['id'], ['_controller' => 'App\\Controller\\FormationController::getFormationEleves'], [], [['text', '/eleves'], ['variable', '/', '[^/]++', 'id', true], ['text', '/formation']], [], [], []],
    'app_home' => [[], ['_controller' => 'App\\Controller\\HomeController::index'], [], [['text', '/accueil']], [], [], []],
